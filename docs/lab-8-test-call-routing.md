...
* Monitor Anita Perez as Charles Holland from the Agent > Monitoring option in Webex Customer Assist Supervisor view
* Test the whisper coach, barge in and pause buttons while monitoring the call.
* Test transcript option as Anita in Webex, while the call is open.
* As Anita Perez set a wrap-up reason in Webex when the call finishes
* Check real time and historical dashboards in webex as cholland.
* Go back to Collaboration Control Hub, and review:
